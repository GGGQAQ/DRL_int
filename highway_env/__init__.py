...
def register_highway_envs():
    ...
    # highway_env_modify.py
    register(
        id='highway-modify-v0',
        entry_point='highway_env.envs:HighwayEnvModify',
    )

    register(
        id='highway-fast-modify-v0',
        entry_point='highway_env.envs:HighwayEnvFastModify',
    )
